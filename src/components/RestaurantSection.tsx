    ...
    >
      <div className="mb-12">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
  onClick={toggleSort}
  className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 md:px-6 md:py-3 md:text-base"
>
  <ArrowUpDown size={16} />
